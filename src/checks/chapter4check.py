...
import numpy as np
import simulation.parameters as SIM
from simulation.aircraft import Aircraft
from simulation.message_types.msg_delta import MsgDelta
from simulation.wind_simulation import WindSimulation

wind = WindSimulation(SIM.ts_simulation)
mav = Aircraft(SIM.ts_simulation)
delta = MsgDelta()
delta.elevator = -0.2
delta.aileron = 0.0
delta.rudder = 0.005
...
delta = np.array([delta.elevator, delta.aileron, delta.rudder, delta.throttle])
